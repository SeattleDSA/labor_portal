...
var unionsRouter = require('./routes/unions');
var usersRouter = require('./routes/users');
var unionDataRouter = require('./routes/union_data');
var densityRouter = require('./routes/density_over_time');
var workplaceOrganizingRouter = require('./routes/workplaceOrganizing');
...
const app = express();
//this allows us to grab the env variables in our pug template as well.
...
app.use('/', indexRouter);
app.use('/', usersRouter);
app.use('/', unionsRouter);
app.use('/', unionDataRouter);
app.use('/', densityRouter);
app.use('/', workplaceOrganizingRouter);
